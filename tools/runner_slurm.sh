#!/bin/bash
#SBATCH --job-name=su24g5_tiny_ade     # job name
...
#SBATCH --output=logs/su24g5_tiny_ade%j.out # output file name
#SBATCH --error=logs/su24g5_tiny_ade%j.err  # error file name
