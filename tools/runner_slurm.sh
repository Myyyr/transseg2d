#!/bin/bash
#SBATCH --job-name=s2tcitgzc     # job name
...
#SBATCH --output=logs/s2tcitgzc%j.out # output file name
#SBATCH --error=logs/s2tcitgzc%j.err  # error file name
...
RESUME="work_dirs/zswinunetv2_tiny_patch4_window7_769x769_160k_cityscapes_good/latest.pth"
