#!/bin/bash
#SBATCH --job-name=supg15tadezc     # job name
...
#SBATCH --output=logs/supg15tadezc%j.out # output file name
#SBATCH --error=logs/supg15tadezc%j.err  # error file name
...
RESUME="work_dirs/zz_upernet_swin_gtv8_g15_tiny_patch4_window7_512x512_160k_ade20k/latest.pth"
