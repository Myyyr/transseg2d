#!/bin/bash
#SBATCH --job-name=su2g20_tiny_ade_pt     # job name
...
#SBATCH --output=logs/su2g20_tiny_ade_pt%j.out # output file name
#SBATCH --error=logs/su2g20_tiny_ade_pt%j.err  # error file name
