#!/bin/bash
#SBATCH --job-name=s28g10badegzc     # job name
...
#SBATCH --output=logs/s28g10badegzc%j.out # output file name
#SBATCH --error=logs/s28g10badegzc%j.err  # error file name
#SBATCH -C v100-32g
...
RESUME="work_dirs/swinunetv2gtv8_g10_base_patch4_window7_512x512_160k_ade20k_good/latest.pth"
