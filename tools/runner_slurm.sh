#!/bin/bash
#SBATCH --job-name=s2badegzc     # job name
...
#SBATCH --output=logs/s2badegzc%j.out # output file name
#SBATCH --error=logs/s2badegzc%j.err  # error file name
...
RESUME="work_dirs/zswinunetv2_base_patch4_window7_512x512_160k_ade20k_good/latest.pth"
