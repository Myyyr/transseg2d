#!/bin/bash
#SBATCH --job-name=swinunetgtv1_tiny_ade_pt     # job name
...
#SBATCH --output=logs/swinunetgtv1_tiny_ade_pt%j.out # output file name
#SBATCH --error=logs/swinunetgtv1_tiny_ade_pt%j.err  # error file name
