#!/bin/bash
#SBATCH --job-name=sunnnd     # job name
...
#SBATCH --output=logs/sunnnd.out # output file name # add %j to id the job
#SBATCH --error=logs/sunnnd.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
