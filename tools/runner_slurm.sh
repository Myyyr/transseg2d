#!/bin/bash
#SBATCH --job-name=su24g1_tiny_ade     # job name
...
#SBATCH --output=logs/su24g1_tiny_ade%j.out # output file name
#SBATCH --error=logs/su24g1_tiny_ade%j.err  # error file name
