#!/bin/bash
#SBATCH --job-name=suptd_tiny_ade_pt     # job name
...
#SBATCH --output=logs/suptd_tiny_ade_pt%j.out # output file name
#SBATCH --error=logs/suptd_tiny_ade_pt%j.err  # error file name
