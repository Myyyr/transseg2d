#!/bin/bash
#SBATCH --job-name=sunnnddbg     # job name
...
#SBATCH --output=logs/sunnnddbg.out # output file name # add %j to id the job
#SBATCH --error=logs/sunnnddbg.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
