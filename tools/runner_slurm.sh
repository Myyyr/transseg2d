#!/bin/bash
#SBATCH --job-name=nosu_tiny_ade_pt     # job name
...
#SBATCH --output=logs/nosu_tiny_ade_pt%j.out # output file name
#SBATCH --error=logs/nosu_tiny_ade_pt%j.err  # error file name
