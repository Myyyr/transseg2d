#!/bin/bash
#SBATCH --job-name=supbngg10     # job name
...
#SBATCH --output=logs/supbngg10.out # output file name # add %j to id the job
#SBATCH --error=logs/supbngg10.err  # error file name # add %j to id the job
# SBATCH -C v100-32g
