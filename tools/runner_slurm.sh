#!/bin/bash
#SBATCH --job-name=supg10badec     # job name
...
#SBATCH --output=logs/supg10badec%j.out # output file name
#SBATCH --error=logs/supg10badec%j.err  # error file name
#SBATCH -C v100-32g
...
RESUME="work_dirs/zz_upernet_swin_gtv8_g10_base_patch4_window7_512x512_160k_ade20k/latest.pth"
