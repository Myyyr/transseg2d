#!/bin/bash
#SBATCH --job-name=su24g1_tiny_ade_pt     # job name
...
#SBATCH --output=logs/su24g1_tiny_ade_pt%j.out # output file name
#SBATCH --error=logs/su24g1_tiny_ade_pt%j.err  # error file name
