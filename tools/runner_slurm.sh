#!/bin/bash
#SBATCH --job-name=s2sadegzc     # job name
...
#SBATCH --output=logs/s2sadegzc%j.out # output file name
#SBATCH --error=logs/s2sadegzc%j.err  # error file name
...
RESUME="work_dirs/zswinunetv2_small_patch4_window7_512x512_160k_ade20k_good/latest.pth"
