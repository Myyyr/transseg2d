#!/bin/bash
#SBATCH --job-name=supg5tadezc     # job name
...
#SBATCH --output=logs/supg5tadezc%j.out # output file name
#SBATCH --error=logs/supg5tadezc%j.err  # error file name
...
RESUME="work_dirs/zz_upernet_swin_gtv8_g5_tiny_patch4_window7_512x512_160k_ade20k/latest.pth"
