#!/bin/bash
#SBATCH --job-name=su2_tiny_ade_pt     # job name
...
#SBATCH --output=logs/su2_tiny_ade_pt%j.out # output file name
#SBATCH --error=logs/su2_tiny_ade_pt%j.err  # error file name
