#!/bin/bash
#SBATCH --job-name=sulr_tiny_ade_pt     # job name
...
#SBATCH --output=logs/sulr_tiny_ade_pt%j.out # output file name
#SBATCH --error=logs/sulr_tiny_ade_pt%j.err  # error file name
