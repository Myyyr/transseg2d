#!/bin/bash
#SBATCH --job-name=supn32     # job name
...
#SBATCH --output=logs/supn32.out # output file name # add %j to id the job
#SBATCH --error=logs/supn32.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
