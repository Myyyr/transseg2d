#!/bin/bash
#SBATCH --job-name=su24g5_tiny_city     # job name
...
#SBATCH --output=logs/su24g5_tiny_city%j.out # output file name
#SBATCH --error=logs/su24g5_tiny_city%j.err  # error file name
