#!/bin/bash
#SBATCH --job-name=gtpg15     # job name
...
#SBATCH --output=logs/gtpg15.out # output file name # add %j to id the job
#SBATCH --error=logs/gtpg15.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
