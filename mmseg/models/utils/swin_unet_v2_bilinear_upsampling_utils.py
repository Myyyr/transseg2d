...
class PatchExpand(nn.Module):
    def __init__(self, input_resolution, dim, dim_scale=2, norm_layer=nn.LayerNorm):
        ...
        self.input_resolution = input_resolution
        self.dim = dim
        self.expand = nn.UpsamplingBilinear2d(scale_factor=(2,2))
        self.reduce_dim = nn.Linear(dim, dim//2)
...
class SwinTransformerBilinearUpsamplingSys(nn.Module):
    r""" Swin Transformer
