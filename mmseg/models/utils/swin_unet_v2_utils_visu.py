...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        torch.save(q, "/etudiants/siscol/t/themyr_l/visu/img/sun/"+str(self.__class__.__name__)+"_Q_"+str(self.lid)+"_.pt")
        torch.save(k, "/etudiants/siscol/t/themyr_l/visu/img/sun/"+str(self.__class__.__name__)+"_K_"+str(self.lid)+"_.pt")
        ...
        if mask is not None:
            ...
            attn = self.softmax(attn)
        torch.save(attn, "/etudiants/siscol/t/themyr_l/visu/img/sun/"+str(self.__class__.__name__)+"_"+str(self.lid)+"_.pt")
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm,lid="0"):
        super().__init__()
        self.dim = dim
        ...
        self.attn = WindowAttention(
            ...
            qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop, proj_drop=drop, lid=lid)
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 drop_path=0., norm_layer=nn.LayerNorm, downsample=None, use_checkpoint=False,lid="0"):
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(dim=dim, input_resolution=input_resolution,
                                 ...
                                 norm_layer=norm_layer,lid=lid+str(i))
...
class BasicLayer_up(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 mlp_ratio=4., qkv_bias=True, qk_scale=None, drop=0., attn_drop=0.,
                 drop_path=0., norm_layer=nn.LayerNorm, upsample=None, use_checkpoint=False, lid="1"):
    ...
    def __init__(self, pretrain_img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(dim=int(embed_dim * 2 ** i_layer),
                               ...
                               use_checkpoint=use_checkpoint, lid="E"+str(i_layer))
        ...
        for i_layer in range(self.num_layers):
            ...
            if i_layer ==0 :
                ...
                layer_up = BasicLayer_up(dim=int(embed_dim * 2 ** (self.num_layers-1-i_layer)),
                                ...
                                use_checkpoint=use_checkpoint, lid="D"+str(i_layer))
