...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0., gt_num=1):
        ...
        self.relative_position_bias_table = nn.Parameter(
            torch.zeros((2 * window_size[0] - 1) * (2 * window_size[1] - 1), num_heads), requires_grad=False)  # 2*Wh-1 * 2*Ww-1, nH
        ...
        self.qkv = nn.Linear(dim, dim * 3, bias=qkv_bias, requires_grad=False)
