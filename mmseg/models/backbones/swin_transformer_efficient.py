...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, H, W, mask=None):
        ...
        attn = attn + nn.functional.interpolate(relative_position_bias.unsqueeze(0), size=(attn.shape[-2],attn.shape[-1]), mode='bilinear')
...
class BasicLayer(nn.Module):
    ...
    def __init__(self,
                 ...
                 downsample=None,
                 use_checkpoint=False,sr_ratio=1):
        super().__init__()
        self.window_size = window_size
...
class SwinTransformerEff(nn.Module):
    ...
    def __init__(self,
                 ...
                 out_indices=(0, 1, 2, 3),
                 frozen_stages=-1,
                 use_checkpoint=False, sr_ratio=[8, 4, 2, 1]):
        super().__init__()
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(
                ...
                use_checkpoint=use_checkpoint,sr_ratio=sr_ratio[i_layer])
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformerEff, self).train(mode)
        self._freeze_stages()
