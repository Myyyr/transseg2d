...
from ..utils.swin_unet_v2_cross_attention_utils_dbg import SwinTransformerCrossAttentionUpsampleSys
...
class SwinUNetV2CrossAttentionUpsampleDbg(nn.Module):
    def __init__(self, pretrain_img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 residual_patch_expand=True,cutscut=True,
                 **kwargs):
        super().__init__()
