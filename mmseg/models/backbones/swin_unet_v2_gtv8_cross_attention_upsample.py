...
from ..utils.swin_unet_v2_gtv8_cross_attention_utils import SwinTransformerGTV8CrossAttentionUpsampleSys
...
class SwinUNetV2GTV8CrossAttentionUpsample(nn.Module):
    def __init__(self, pretrain_img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.swin_unet = SwinTransformerGTV8CrossAttentionUpsampleSys(pretrain_img_size=pretrain_img_size,
