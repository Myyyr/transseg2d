...
class MixVisionTransformerGTBeta(nn.Module):
...
class mit_gt_beta_b0(MixVisionTransformerGTBeta):
    def __init__(self, **kwargs):
        super(mit_gt_beta_b0, self).__init__(
...
@BACKBONES.register_module()
class mit_gt_beta_b1(MixVisionTransformerGTBeta):
    def __init__(self, **kwargs):
        super(mit_gt_beta_b1, self).__init__(
...
@BACKBONES.register_module()
class mit_gt_beta_b2(MixVisionTransformerGTBeta):
    def __init__(self, **kwargs):
        super(mit_gt_beta_b2, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class mit_gt_beta_b3(MixVisionTransformerGTBeta):
    def __init__(self, **kwargs):
        super(mit_gt_beta_b3, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class mit_gt_beta_b4(MixVisionTransformerGTBeta):
    def __init__(self, **kwargs):
...
@BACKBONES.register_module()
class mit_gt_beta_b5(MixVisionTransformerGTBeta):
    def __init__(self, **kwargs):
        super(mit_gt_beta_b5, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
